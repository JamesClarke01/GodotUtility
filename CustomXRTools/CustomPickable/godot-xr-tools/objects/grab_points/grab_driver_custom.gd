class_name XRToolsGrabDriverCustom
...
## Target pickable
var target : XRToolsPickableCustom

## Primary grab information
var primary : GrabCustom = null

## Secondary grab information
var secondary : GrabCustom = null
...
func add_grab(p_grab : GrabCustom) -> void:
...
func get_grab(by : Node3D) -> GrabCustom:
...
func remove_grab(p_grab : GrabCustom) -> void:
...
static func create_snap(
	p_target : Node3D,
	p_grab : GrabCustom) -> XRToolsGrabDriverCustom:
