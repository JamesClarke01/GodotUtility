@tool
class_name XRToolsPickableCustom
extends RigidBody3D
...
var _grab_driver: XRToolsGrabDriverCustom = null
...
func is_xr_class(name : String) -> bool:
	return name == "XRToolsPickableCustom"
...
## This method requests highlighting of the [XRToolsPickableCustom].
