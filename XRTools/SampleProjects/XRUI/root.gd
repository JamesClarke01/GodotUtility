...
@onready var menuScene = $Viewport2Din3D/Viewport/Menu #Important
...
func setupMenuSignals():
	menuScene.button_pressed.connect(_on_menu_button_pressed)
	menuScene.slider_changed.connect(_on_slider_changed)
...
func _on_slider_changed():
	...
	material.albedo_color = Color(menuScene.red, menuScene.green, menuScene.blue)
